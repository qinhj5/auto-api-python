...
class GoogleDrive:
    ...
    def upload_file(self, file_path: str, file_name: str = None, folder_name: str = None) -> dict:
        """
        ...
        Args:
            ...
            folder_name (str): Name of the folder in which to upload the file. Default is None (upload to root).
